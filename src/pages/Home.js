      ...
      <section className="relative min-h-screen flex items-center" data-testid="hero-section">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-32">
          ...
          >
            ...
            <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-light text-white leading-tight tracking-tight">
              {t('hero.title')}
            </h1>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link to="/products">
                <button
                  className="bg-[#D4AF37] text-[#1A1713] px-8 py-4 text-sm font-medium tracking-wide uppercase hover:bg-[#B87333] hover:text-white transition-colors duration-300"
      ...
      <section className="py-24 lg:py-32" data-testid="featured-products-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-light text-[#1A1713] tracking-tight">
              {t('products.title')}
            </h2>
          </motion.div>
          ...
          >
            <Link to="/products">
              <button
                className="border border-[#1A1713] text-[#1A1713] px-8 py-4 text-sm font-medium tracking-wide uppercase hover:bg-[#1A1713] hover:text-[#FDFBF7] transition-all duration-300"
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {whyUsFeatures.map((feature, index) => (
              <motion.div
                ...
                className="text-center p-8 bg-[#FDFBF7] border border-[#E8E2D2] hover:border-[#D4AF37]/30 transition-colors"
      ...
      <section className="py-24 lg:py-32" data-testid="how-to-order-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-[#F7F4EB] border border-[#E8E2D2] p-8 lg:p-12 mb-12"
          >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1, duration: 0.6 }}
                className="relative bg-[#FDFBF7] border border-[#E8E2D2] p-8 text-center"
                data-testid={`order-step-${item.step}`}
              >
                <div className="text-[#D4AF37] font-heading text-4xl font-light mb-4">
                  0{item.step}
                </div>
