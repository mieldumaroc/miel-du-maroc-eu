...
const translations = {
  en: {
    ...
    products: { title: 'Our Honey Collection', subtitle: 'Each jar captures the essence of Morocco\'s pristine landscapes', viewDetails: 'View Details', inquire: 'Order via WhatsApp', from: 'From', perKg: 'per 500g', healthBenefits: 'Health Benefits', selectSize: 'Select Size' },
    ...
    contact: { title: 'Get in Touch', subtitle: 'We\'d love to hear from you', whatsapp: 'Message us on WhatsApp', whatsappText: 'Primary contact for orders and inquiries', email: 'Email', emailText: 'For detailed questions', location: 'Location', locationText: 'Marrakech, Morocco', form: { name: 'Your Name', email: 'Email Address', message: 'Your Message', send: 'Send Message' } },
    shipping: { title: 'Shipping & Delivery', subtitle: 'We deliver across Europe with care', info: 'All orders are carefully packaged and shipped from Morocco. Typical delivery to Europe takes 7-14 business days.' },
    faq: { title: 'Frequently Asked Questions', subtitle: 'Everything you need to know' },
    blog: { title: 'Our Blog', subtitle: 'Discover the world of Moroccan honey', readMore: 'Read More', backToBlog: 'Back to Blog' },
  ...
  fr: {
    ...
    products: { title: 'Notre Collection de Miels', subtitle: 'Chaque pot capture l\'essence des paysages vierges du Maroc', viewDetails: 'Voir Details', inquire: 'Commander via WhatsApp', from: 'A partir de', perKg: 'par 500g', healthBenefits: 'Bienfaits pour la Sante', selectSize: 'Choisir Taille' },
    ...
    contact: { title: 'Contactez-Nous', subtitle: 'Nous serions ravis de vous entendre', whatsapp: 'Ecrivez-nous sur WhatsApp', whatsappText: 'Contact principal pour les commandes et demandes', email: 'Email', emailText: 'Pour les questions detaillees', location: 'Emplacement', locationText: 'Marrakech, Maroc', form: { name: 'Votre Nom', email: 'Adresse Email', message: 'Votre Message', send: 'Envoyer le Message' } },
    shipping: { title: 'Livraison & Expedition', subtitle: 'Nous livrons a travers l\'Europe avec soin', info: 'Toutes les commandes sont soigneusement emballees et expediees du Maroc. La livraison typique en Europe prend 7 a 14 jours ouvrables.' },
    faq: { title: 'Questions Frequentes', subtitle: 'Tout ce que vous devez savoir' },
    blog: { title: 'Notre Blog', subtitle: 'Decouvrez le monde du miel marocain', readMore: 'Lire la Suite', backToBlog: 'Retour au Blog' },
  ...
  de: {
    ...
    products: { title: 'Unsere Honigkollektion', subtitle: 'Jedes Glas fangt die Essenz der unberuhrten Landschaften Marokkos ein', viewDetails: 'Details Ansehen', inquire: 'Uber WhatsApp Bestellen', from: 'Ab', perKg: 'pro 500g', healthBenefits: 'Gesundheitsvorteile', selectSize: 'Grosse Wahlen' },
    ...
    contact: { title: 'Kontaktieren Sie Uns', subtitle: 'Wir freuen uns von Ihnen zu horen', whatsapp: 'Schreiben Sie uns auf WhatsApp', whatsappText: 'Hauptkontakt fur Bestellungen und Anfragen', email: 'E-Mail', emailText: 'Fur detaillierte Fragen', location: 'Standort', locationText: 'Marrakesch, Marokko', form: { name: 'Ihr Name', email: 'E-Mail-Adresse', message: 'Ihre Nachricht', send: 'Nachricht Senden' } },
    shipping: { title: 'Versand & Lieferung', subtitle: 'Wir liefern mit Sorgfalt nach ganz Europa', info: 'Alle Bestellungen werden sorgfaltig verpackt und aus Marokko verschickt. Typische Lieferung nach Europa dauert 7-14 Werktage.' },
    faq: { title: 'Haufig Gestellte Fragen', subtitle: 'Alles was Sie wissen mussen' },
    blog: { title: 'Unser Blog', subtitle: 'Entdecken Sie die Welt des marokkanischen Honigs', readMore: 'Weiterlesen', backToBlog: 'Zuruck zum Blog' },
  ...
  nl: {
    ...
    products: { title: 'Onze Honingcollectie', subtitle: 'Elke pot vangt de essentie van de ongerepte landschappen van Marokko', viewDetails: 'Details Bekijken', inquire: 'Bestel via WhatsApp', from: 'Vanaf', perKg: 'per 500g', healthBenefits: 'Gezondheidsvoordelen', selectSize: 'Kies Maat' },
    ...
    contact: { title: 'Neem Contact Op', subtitle: 'We horen graag van u', whatsapp: 'Stuur ons een bericht op WhatsApp', whatsappText: 'Primair contact voor bestellingen en vragen', email: 'E-mail', emailText: 'Voor gedetailleerde vragen', location: 'Locatie', locationText: 'Marrakech, Marokko', form: { name: 'Uw Naam', email: 'E-mailadres', message: 'Uw Bericht', send: 'Bericht Versturen' } },
    shipping: { title: 'Verzending & Levering', subtitle: 'We leveren met zorg door heel Europa', info: 'Alle bestellingen worden zorgvuldig verpakt en verzonden vanuit Marokko. Typische levering naar Europa duurt 7-14 werkdagen.' },
    faq: { title: 'Veelgestelde Vragen', subtitle: 'Alles wat u moet weten' },
    blog: { title: 'Ons Blog', subtitle: 'Ontdek de wereld van Marokkaanse honing', readMore: 'Lees Meer', backToBlog: 'Terug naar Blog' },
