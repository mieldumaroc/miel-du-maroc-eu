...
const translations = {
  en: {
    ...
    products: { title: 'Our Honey Collection', subtitle: 'Each jar captures the essence of Morocco\'s pristine landscapes', viewDetails: 'View Details', inquire: 'Order via WhatsApp', from: 'From', perKg: 'per 500g', healthBenefits: 'Health Benefits', selectSize: 'Select Size', addToCart: 'Add to Cart', orderWhatsApp: 'Hello, I would like to order' },
    excellence: 'Excellence', delivery: 'Delivery', wellness: 'Wellness', contact_label: 'Contact',
    chatWhatsApp: 'Chat on WhatsApp',
    searchPlaceholder: 'Search...',
    tableHoney: 'Honey', tableCategory: 'Category', tableBenefits: 'Key Benefits', tablePrice: 'Price (500g)',,
