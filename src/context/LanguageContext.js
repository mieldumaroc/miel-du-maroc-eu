...
const translations = {
  en: {
    ...
    products: { title: 'Our Honey Collection', subtitle: 'Each jar captures the essence of Morocco\'s pristine landscapes', viewDetails: 'View Details', inquire: 'Order via WhatsApp', from: 'From', perKg: 'per 500g', healthBenefits: 'Health Benefits', selectSize: 'Select Size', addToCart: 'Add to Cart', orderWhatsApp: 'Hello, I would like to order', excellence: 'Excellence', delivery: 'Delivery', wellness: 'Wellness', contact_label: 'Contact', chatWhatsApp: 'Chat on WhatsApp', searchPlaceholder: 'Search...', tableHoney: 'Honey', tableCategory: 'Category', tableBenefits: 'Key Benefits', tablePrice: 'Price (500g)' },
  ...
  de: {
    ...
    excellence: 'Exzellenz', delivery: 'Lieferung', wellness: 'Wohlbefinden', contact_label: 'Kontakt',
    chatWhatsApp: 'Auf WhatsApp chatten',
    searchPlaceholder: 'Suchen...',
    tableHoney: 'Honig', tableCategory: 'Kategorie', tableBenefits: 'Hauptvorteile', tablePrice: 'Preis (500g)',,
  ...
  ar: {
    ...
    products: { title: 'مجموعة عسلنا', subtitle: 'كل برطمان يحمل جوهر مناطق المغرب النقية', viewDetails: 'عرض التفاصيل', inquire: 'اطلب عبر واتساب', from: 'من', perKg: 'لكل ٥٠٠ غ', healthBenefits: 'الفوائد الصحية', selectSize: 'اختر الحجم', addToCart: 'أضف إلى السلة', orderWhatsApp: 'مرحباً، أريد طلب' },
    excellence: 'التميز', delivery: 'التوصيل', wellness: 'العافية', contact_label: 'تواصل معنا',
    chatWhatsApp: 'تحدث على واتساب',
    searchPlaceholder: 'البحث...',
    tableHoney: 'العسل', tableCategory: 'الفئة', tableBenefits: 'الفوائد الرئيسية', tablePrice: 'السعر (500غ)',,
  ...
  nl: {
    ...
    products: { title: 'Onze Honingcollectie', subtitle: 'Elke pot vangt de essentie van de ongerepte landschappen van Marokko', viewDetails: 'Details Bekijken', inquire: 'Bestel via WhatsApp', from: 'Vanaf', perKg: 'per 500g', healthBenefits: 'Gezondheidsvoordelen', selectSize: 'Kies Maat', addToCart: 'In winkelwagen', orderWhatsApp: 'Hallo, ik wil graag bestellen' },
    excellence: 'Excellentie', delivery: 'Levering', wellness: 'Welzijn', contact_label: 'Contact',
    chatWhatsApp: 'Chatten op WhatsApp',
    searchPlaceholder: 'Zoeken...',
    tableHoney: 'Honing', tableCategory: 'Categorie', tableBenefits: 'Belangrijkste Voordelen', tablePrice: 'Prijs (500g)',,
