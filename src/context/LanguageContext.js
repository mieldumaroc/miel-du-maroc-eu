...
const translations = {
  ...
  ar: {
    ...
    products: { title: 'مجموعة عسلنا', subtitle: 'كل برطمان يحمل جوهر مناطق المغرب النقية', viewDetails: 'عرض التفاصيل', inquire: 'اطلب عبر واتساب', from: 'من', perKg: 'لكل ٥٠٠ غ', healthBenefits: 'الفوائد الصحية', selectSize: 'اختر الحجم', addToCart: 'أضف إلى السلة', orderWhatsApp: 'مرحباً، أريد طلب', excellence: 'التميز', delivery: 'التوصيل', wellness: 'العافية', contact_label: 'تواصل معنا', chatWhatsApp: 'تحدث على واتساب', searchPlaceholder: 'البحث...', tableHoney: 'العسل', tableCategory: 'الفئة', tableBenefits: 'الفوائد الرئيسية', tablePrice: 'السعر (500غ)' },,
